...
const weapons = {
  "Light Melee": [
    ...
    "Sabre, +1 dmg",
    "Hatchet, +1 piercing",
    "Club, stun disadvantage",
    "Rapier, Exploding"
  ],
  "Medium Melee": [
    "Long sword, +1 dmg",
    "Spear, reach",
    "War hammer, stun disadvantage",
    "Mace, +1 dmg adjacent",
    "Scepter, +1 elemental dmg",
    "Battle axe, +1 piercing"
  ],
  "Heavy Melee": [
    "Staff, +1 armor",
    "Great sword, +1 dmg",
    "Double axe, +1 piercing",
    "Maul, stun disadvantage",
    "Morningstar, +1 dmg adjacent",
    "Poleaxe, +1 piercing"
  ],
  "Ranged": [
    "Bow, d6",
    "Recurve bow, d6, exploding",
    "Crossbow, d8",
    "Heavy crossbow, d10, shoot or run",
...
const armorTable = [
  ...
  "Garb, 1 armor and 1 energy shield",
  "Garb, 1 armor and 1 energy shield",
  "Chainmail, 2 armor and 1 energy shield",
  "Raiment, 1 armor and 2 energy shield"
];
...
function treasureOutcome(r){
  switch(r){
    case 1: return `Trinket / ${rollDie(6)} coins`;
    case 2: return `${rollDie(4)} trinkets / ${rollDie(8)} coins`;
    case 3: return `${rollDie(6)} trinkets / ${rollDie(6)+rollDie(6)} coins`;
    case 4: return `${rollDie(4)+rollDie(4)} trinkets / ${rollDie(8)+rollDie(8)} coins`;
...
function generateLoot(){
  ...
  if(type==="Weapon"){
    ...
    const item = weapons[subtype][rollDie(weapons[subtype].length)-1];
    itemName = item;
